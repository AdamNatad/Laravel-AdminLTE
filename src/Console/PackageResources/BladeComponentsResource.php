...
namespace AdamNatad\LaravelAdminLte\Console\PackageResources;

use Illuminate\Support\Facades\File;
use AdamNatad\LaravelAdminLte\Helpers\CommandHelper;
...
class BladeComponentsResource extends PackageResource
{
    ...
    protected function adaptPublishedComponentClasses()
    {
        ...
        foreach ($files as $file) {
            ...
            $content = str_replace(
                'namespace AdamNatad\LaravelAdminLte\View\Components',
