...
namespace AdamNatad\LaravelAdminLte\Helpers;

use Illuminate\Support\Facades\View;
use AdamNatad\LaravelAdminLte\Events\ReadingDarkModePreference;
use AdamNatad\LaravelAdminLte\Http\Controllers\DarkModeController;
